...
#ifndef _GVV_GLSL_SYNTAX_HIGHLIGHTER_H_
#define _GVV_GLSL_SYNTAX_HIGHLIGHTER_H_
 ...
 */
class GVVIEWERGUI_EXPORT GvvGLSLSyntaxHighlighter : public QSyntaxHighlighter
{
	// Qt macro
    Q_OBJECT
...
public:
	 ...
	 */
    GvvGLSLSyntaxHighlighter( QTextDocument* pParent = 0 );
