...
#ifndef _GVV_EDIT_CAMERA_ACTION_H_
#define _GVV_EDIT_CAMERA_ACTION_H_
...
class GVVIEWERGUI_EXPORT GvvEditCameraAction : public GvvAction
{
...
public:
	 ...
	 */
	GvvEditCameraAction(const QString& pFileName, 
						const QString& pText = QCoreApplication::translate( "GvvEditCameraAction", cDefaultText ),
...
private:
	 ...
	 */
	GvvEditCameraAction( const GvvEditCameraAction& );

	/**
	 * Copy operator forbidden.
	 */
	GvvEditCameraAction& operator=( const GvvEditCameraAction& );
