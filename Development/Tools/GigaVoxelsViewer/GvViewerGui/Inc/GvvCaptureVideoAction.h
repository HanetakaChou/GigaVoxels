...
#ifndef _GVV_CAPTURE_VIDEO_ACTION_H_
#define _GVV_CAPTURE_VIDEO_ACTION_H_
...
class GVVIEWERGUI_EXPORT GvvCaptureVideoAction : public GvvAction
{
...
public:
	 ...
	 */
	GvvCaptureVideoAction(const QString& pFileName, 
						const QString& pText = QCoreApplication::translate( "GvvCaptureVideoAction", cDefaultText ),
						//const QString& pIconName = QString::null, 
						const QString& pIconName = QString( "Camera" ) ,
						bool pIsToggled = true );	

	/**
	 * Destructor.
	 */
	virtual ~GvvCaptureVideoAction();
...
private:
	 ...
	 */
	GvvCaptureVideoAction( const GvvCaptureVideoAction& );

	/**
	 * Copy operator forbidden.
	 */
	GvvCaptureVideoAction& operator=( const GvvCaptureVideoAction& );
