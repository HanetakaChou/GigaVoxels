...
void SampleCore::setSilouhetteProperty(int value) 
{
	silouhetteThickness = value; 
	GV_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cNum, &silouhetteThickness, sizeof( silouhetteThickness ), 0, cudaMemcpyHostToDevice ) );
