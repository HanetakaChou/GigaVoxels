...
private slots:
	 ...
	 */
	void on__noiseAmplitudeSpinBox_valueChanged( double pValue );

	/**
	 * Slot called when noise frequency changes
	 */
	void on__noiseFrequencySpinBox_valueChanged( int pValue );

	/**
	 * Slot called when noise persistancy changes
	 */
	void on__noisePersistancySpinBox_valueChanged( double pValue );

	void on__useRealNormalsCheckBox_clicked (bool checked );
};
