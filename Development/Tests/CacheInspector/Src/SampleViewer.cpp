...
void SampleViewer::init()
{
	...
	// Cache inspector viewer
	_inspectorView = new InspectorView();
	_inspectorView->initialize( _sampleCore );
	_inspectorView->show();
...
void SampleViewer::keyPressEvent( QKeyEvent* pEvent )
{
	switch ( pEvent->key() )
	{
		...
		case Qt::Key_M:
			// Update cache inspector view
			updateCacheInspectorView();
			break;
...
/******************************************************************************
 * Update the cache inspector view
 ******************************************************************************/
void SampleViewer::updateCacheInspectorView()
{
	_inspectorView->populate( _sampleCore );
}
