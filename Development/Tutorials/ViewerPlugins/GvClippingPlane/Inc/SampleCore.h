...
typedef GvRenderer::GvVolumeTreeRendererCUDA
<
 ...
 */
class SampleCore : public GvViewerCore::GvvPipelineInterface//, public QObject
{
	// Qt Macro
	//Q_OBJECT
...
public:
	 ...
	 */
	virtual void getClippingPlane( float& pNormalX, float& pNormalY, float& pNormalZ, float& pDistance ) const;
	 ...
	 * @param pDistance the distance
	 */
	virtual void setClippingPlane( float pNormalX, float pNormalY, float pNormalZ, float pDistance );
...
protected:
	 ...
	 */
	qglviewer::ManipulatedFrame* _clippingPlaneFrame;
...
//	 */
//	void onClippingPlaneFrameManipulated();
