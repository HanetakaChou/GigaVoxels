...
void CustomSectionEditor::populate( GvViewerCore::GvvBrowsable* pBrowsable )
{
	...
	{
		// Dof parameters
		_apertureDoubleSpinBox->setValue( pipeline->getAperture() );
		_focalLengthDoubleSpinBox->setValue( pipeline->getFocalLength() );
		_planeInFocusDoubleSpinBox->setValue( pipeline->getPlaneInFocus() );
 ...
 ******************************************************************************/
void CustomSectionEditor::on__apertureDoubleSpinBox_valueChanged( double value )
{
	...
	sampleCore->setAperture( value );
}

/******************************************************************************
 * Slot called when dof focal lenght value has changed
 ******************************************************************************/
void CustomSectionEditor::on__focalLengthDoubleSpinBox_valueChanged( double value )
{
	GvvApplication& application = GvvApplication::get();
	GvvMainWindow* mainWindow = application.getMainWindow();
	Gvv3DWindow* window3D = mainWindow->get3DWindow();
	...
	sampleCore->setFocalLength( value );
}

/******************************************************************************
 * Slot called when dof plane in focus value has changed
 ******************************************************************************/
void CustomSectionEditor::on__planeInFocusDoubleSpinBox_valueChanged( double value )
{
	GvvApplication& application = GvvApplication::get();
	GvvMainWindow* mainWindow = application.getMainWindow();
	Gvv3DWindow* window3D = mainWindow->get3DWindow();
	...
	sampleCore->setPlaneInFocus( value );
}
