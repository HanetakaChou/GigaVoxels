...
void SampleCore::init()
{
	...
	//mProducer->_filename = std::string( "sponza.obj" );	// ajouter un test sur le fichier d'entrée (warning, error, etc..)
	//mProducer->_filename = std::string( "J:\\Projects\\Inria\\GigaVoxelsTrunk\\Release\\Bin\\Data\\3DModels\\dabrovic-sponza\\sponza.obj" );	// ajouter un test sur le fichier d'entrée (warning, error, etc..)
