...
,	_shaderProgramParticleSystem( NULL )
{
	...
	//_pointsShaderProgram = GsShaderManager::createShaderProgram( vertexShaderFilename.toLatin1().constData(), NULL, fragmentShaderFilename.toLatin1().constData() );
	//GsShaderManager::linkShaderProgram( _pointsShaderProgram );
	...
	//_pointSpritesShaderProgram = GsShaderManager::createShaderProgram( vertexShaderFilename.toLatin1().constData(), geometryShaderFilename.toLatin1().constData(), fragmentShaderFilename.toLatin1().constData() );
	//GsShaderManager::linkShaderProgram( _pointSpritesShaderProgram );
