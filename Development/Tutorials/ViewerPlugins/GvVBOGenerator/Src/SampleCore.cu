...
void SampleCore::init()
{
	...
	//_renderer = new RendererType( _volumeTree, _cache );
	...
	_particleSystem  = /*_pipeline->editProducer()*/_producer->_particleSystem;
	_pipeline->editCache()->editVBOCacheManager()->_particleSystem = /*_pipeline->editProducer()*/_producer->_particleSystem;
...
void SampleCore::setNbPoints( unsigned int pValue )
{
	...
	// Update producer
	/*_pipeline->editProducer()*/_producer->setNbPoints( pValue );
	
	// Update DEVICE memory with "voxel scale"
	GS_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cNbPoints, &_nbPoints, sizeof( _nbPoints ), 0, cudaMemcpyHostToDevice ) );
...
{
	return /*_pipeline->getProducer()*/_producer->getPointSizeFader();
}
...
{
	/*_pipeline->editProducer()*/_producer->setPointSizeFader( pValue );
...
void SampleCore::setMinNbPointsPerBrick( unsigned int pValue )
{
	...
	// Update DEVICE memory with "voxel scale"
	GS_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cMinNbPointsPerBrick, &_minNbPointsPerBrick, sizeof( _minNbPointsPerBrick ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setGeometricCriteriaGlobalUsage( bool pFlag )
{
	...
	// Update DEVICE memory with "voxel scale"
	GS_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cGeometricCriteriaGlobalUsage, &_geometricCriteriaGlobalUsage, sizeof( _geometricCriteriaGlobalUsage ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setApparentMinSizeCriteria( bool pFlag )
{
	...
	// Update DEVICE memory with "voxel scale"
	GS_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cApparentMinSizeCriteria, &_apparentMinSizeCriteria, sizeof( _apparentMinSizeCriteria ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setApparentMinSize( float pValue )
{
	...
	// Update DEVICE memory with "voxel scale"
	GS_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cApparentMinSize, &_apparentMinSize, sizeof( _apparentMinSize ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setApparentMaxSizeCriteria( bool pFlag )
{
	...
	// Update DEVICE memory with "voxel scale"
	GS_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cApparentMaxSizeCriteria, &_apparentMaxSizeCriteria, sizeof( _apparentMaxSizeCriteria ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setApparentMaxSize( float pValue )
{
	...
	// Update DEVICE memory with "voxel scale"
	GS_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cApparentMaxSize, &_apparentMaxSize, sizeof( _apparentMaxSize ), 0, cudaMemcpyHostToDevice ) );
...
void SampleCore::setTexture( bool pFlag )
{
	...
	// Update DEVICE memory with "voxel scale"
	//GS_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cHasTexture, &_hasTexture, sizeof( _hasTexture ), 0, cudaMemcpyHostToDevice ) );
