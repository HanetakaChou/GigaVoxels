...
typedef Loki::TL::MakeTypelist< float4 >::Result DataType; // Sphere positions
...
typedef GvStructure::GsDataProductionManager< DataStructureType > DataProductionManager;
typedef Producer
<	
	DataStructureType,
...
public:
    ...
    unsigned int getNbSpheresTotal() const;
    void setNbSpheresTotal( unsigned int pValue );
    void regeneratePositions();
    bool getUserDefinedMinLevelOfResolutionToHandleMode() const;
	void setUserDefinedMinLevelOfResolutionToHandleMode( bool pFlag );
	unsigned int getUserDefinedMinLevelOfResolutionToHandle() const;
	void setUserDefinedMinLevelOfResolutionToHandle( unsigned int pValue );
	bool getAutomaticMinLevelOfResolutionToHandleMode() const;
	void setAutomaticMinLevelOfResolutionToHandleMode( bool pFlag );
	unsigned int getAutomaticMinLevelOfResolutionToHandle() const;
//	void setAutomaticMinLevelOfResolutionToHandle( unsigned int pValue );
	unsigned int getSphereBrickIntersectionType() const;
	void setSphereBrickIntersectionType( unsigned int pValue );
	float getSphereRadiusFader() const;
	void setSphereRadiusFader( float pValue );
	bool hasGeometricCriteria() const;
	void setGeometricCriteria( bool pFlag );
	unsigned int getMinNbSpheresPerBrick() const;
	void setMinNbSpheresPerBrick( unsigned int pValue );
	bool hasScreenBasedCriteria() const;
	void setScreenBasedCriteria( bool pFlag );
	bool hasAbsoluteSizeCriteria() const;
	void setAbsoluteSizeCriteria( bool pFlag );
	bool hasFixedSizeSphere() const;
	void setFixedSizeSphere( bool pFlag );
    ...
    void setSphereDiameterCoeff( double pValue );
    unsigned int getSphereDiameterCoeff() const;
    void setScreenSpaceCoeff( unsigned int pValue );
    unsigned int getScreenSpaceCoeff() const;
    ...
    bool hasShaderBlurSphere() const;
    void setShaderBlurSphere( bool pFlag );
    bool hasShaderFog() const;
    void setShaderFog( bool pFlag );
    float getFogDensity() const;
    void setFogDensity( float pValue );
    const float4& getShaderFogColor() const;
    void setShaderFogColor( float pR, float pG, float pB, float pA );
    bool IsLightSourceType() const;
    void setLightSourceType( bool pFlag );
    bool hasShading() const;
    void setShading( bool pFlag );
    bool hasBugCorrection() const;
    void setBugCorrection( bool pFlag );
    float getIlluminationCoeff() const;
    void setIlluminationCoeff( float pValue );
	 ...
	 * @param pValue ...
	 */
	void setNumberOfReflections( int pValue );

	/**
	 * ...
	 *
	 * @param pPipelineViewer ...
	 */
	void setPipelineViewer( GvViewerGui::GvvPipelineInterfaceViewer* pPipelineViewer );
...
protected:
	 ...
	 */
	unsigned int _nbSpheres;
    unsigned int _nbSpheresTotal;
	bool _userDefinedMinLevelOfResolutionToHandleMode;
	unsigned int _userDefinedMinLevelOfResolutionToHandle;
	bool _automaticMinLevelOfResolutionToHandleMode;
	//unsigned int _automaticMinLevelOfResolutionToHandle;
	unsigned int _sphereBrickIntersectionType;
	bool _geometricCriteria;
	unsigned int _minNbSpheresPerBrick;
	bool _screenBasedCriteria;
	bool _absoluteSizeCriteria;
	bool _fixedSizeSphere;
	bool _meanSizeOfSpheres;
    double _sphereDiameterCoeff;
	bool _shaderUseUniformColor;
	float4 _shaderUniformColor;
    bool _shaderAnimation;
    bool _shaderBlurSphere;
    bool _shaderFog;
    float _shaderFogDensity;
    float4 _shaderFogColor;
    bool _shaderLightSourceType;
    bool _shading;
    bool _bugCorrection;
    float _sphereRadiusFader;
    float _illuminationCoeff;
    unsigned int _screenSpaceCoeff;


	/**
	 * ...
	 */
	GvViewerGui::GvvPipelineInterfaceViewer * _pipelineViewer;
...
private:
	 ...
	 * Data structure
	 */
	DataStructureType* _volumeTree;

	/**
	 * Cache
	 */
	DataProductionManager* _cache;
	...
	/**
	 * The number of reflexion the camera has already done
	 */
	float3 cameraInBrick; 	

	unsigned int _numberOfReflections;
