 ...
 * 
 ******************************************************************************/
extern "C" GVINFINITESKY_EXPORT GvvPluginInterface* createPlugin( GvvPluginManager& pManager )
{
...
void Plugin::initialize()
{
	...
	// In this case, the GigaSpace pipeline requires the viewer to be able to retrive camera parameters
	Gvv3DWindow* window3D = mainWindow->get3DWindow();
	_pipeline->setPipelineViewer( window3D->getPipelineViewer() );
