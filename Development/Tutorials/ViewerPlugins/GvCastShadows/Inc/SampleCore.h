...
public:
	 ...
	 * @param pZ the Z light position
	 */
	void setCameraLight( float pX, float pY, float pZ );
	 ...
	 * @param pZ the translation on z axis
	 */
	void getShadowReceiverTranslation( float& pX, float& pY, float& pZ ) const;
	 ...
	 * @param pZ the translation on z axis
	 */
	void setShadowReceiverTranslation( float pX, float pY, float pZ );
	 ...
	 * @param pZ the z component of the rotation vector
	 */
	void getShadowReceiverRotation( float& pAngle, float& pX, float& pY, float& pZ ) const;
	 ...
	 * @param pZ the z component of the rotation vector
	 */
	void setShadowReceiverRotation( float pAngle, float pX, float pY, float pZ );
	 ...
	 * @param pValue the uniform scale
	 */
	void getShadowReceiverScale( float& pValue ) const;
	 ...
	 * @param pValue the uniform scale
	 */
	void setShadowReceiverScale( float pValue );
	 ...
	 * @return the 3D model filename to load
	 */
	virtual std::string getShadowCaster3DModelFilename() const;
	 ...
	 * @param pFilename the 3D model filename to load
	 */
	virtual void setShadowCaster3DModelFilename( const std::string& pFilename );
	 ...
	 * @param pZ the translation on z axis
	 */
	void getShadowCasterTranslation( float& pX, float& pY, float& pZ ) const;
	 ...
	 * @param pZ the translation on z axis
	 */
	void setShadowCasterTranslation( float pX, float pY, float pZ );
	 ...
	 * @param pZ the z component of the rotation vector
	 */
	void getShadowCasterRotation( float& pAngle, float& pX, float& pY, float& pZ ) const;
	 ...
	 * @param pZ the z component of the rotation vector
	 */
	void setShadowCasterRotation( float pAngle, float pX, float pY, float pZ );
	 ...
	 * @param pValue the uniform scale
	 */
	void getShadowCasterScale( float& pValue ) const;
	 ...
	 * @param pValue the uniform scale
	 */
	void setShadowCasterScale( float pValue );
...
private:
	 ...
	 * Sample Viewer
	 */ 
	GvViewerGui::GvvPipelineInterfaceViewer* sviewer;
