 ...
 * 
 ******************************************************************************/
extern "C" GVPRODUCTIONPOLICIES_EXPORT GvvPluginInterface* createPlugin( GvvPluginManager& pManager )
{
...
:	_manager( pManager )
,	_name( "GvProductionPoliciesPlugin" )
...
void Plugin::initialize()
{
	...
	editorWindow->registerEditorFactory( GvvPipelineInterface::cTypeName, &CustomEditor::create );
