...
::doRender( const float4x4& pModelMatrix, const float4x4& pViewMatrix, const float4x4& pProjectionMatrix, const int4& pViewport )
{
	...
	GS_CUDA_SAFE_CALL( cudaGraphicsMapResources( 6, &_graphicsResources[ 0 ], 0 ) );
...
::initializeShaderProgram()
{
	...
	QString vertexShaderFilename = shaderRepository + QDir::separator() + QString( "GvRendererGLSL" ) + QDir::separator() + QString( "gigaspace_vert.glsl" );
	...
	QString fragmentShaderFilename = shaderRepository + QDir::separator() + QString( "GvRendererGLSL" ) + QDir::separator() + QString( "gigaspace_frag.glsl" );
