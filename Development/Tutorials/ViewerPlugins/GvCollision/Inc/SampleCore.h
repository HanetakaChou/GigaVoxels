...
typedef GvRendering::GsRendererCUDA< DataStructureType, DataProductionManager, ShaderType > RendererType;
...
public:
	 ...
	 */
	void setParticlesNumber( int particles );
	 ...
	 */
	unsigned int getNoiseFirstFrequency() const;
	 ...
	 */
	void setNoiseFirstFrequency( unsigned int pValue );
	 ...
	 */
	unsigned int getNoiseMaxFrequency() const;
	 ...
	 */
	void setNoiseMaxFrequency( unsigned int pValue );
...
protected:
	 ...
	 */
	unsigned int _noiseFirstFrequency;

	/**
	 * Noise max frequency
	 */
	unsigned int _noiseMaxFrequency;
...
private:
	...
	/**
	 * Indicate if the animation must run or not.
	 */
	bool _runAnimation;
