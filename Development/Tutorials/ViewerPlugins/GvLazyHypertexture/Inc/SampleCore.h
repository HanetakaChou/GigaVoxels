...
public:
	 ...
	 */
	void setNoiseFrequency (int pValue);
		/**
	 ...
	 * @param pValue the desired value
	 */
	void setNoiseAmplitude (float pValue);
	 ...
	 * @param pValue the desired value
	 */
	void setNoisePersistancy (float pValue);


	void setUseRealNormals (bool pValue);
...
protected:
	 ...
	 * Noise Persistancy
	 */
	float _noisePersistancy;


	bool _useRealNormals;
