...
,	_bufferHeight( 0 )
,	_filename()
,	_screenBasedCriteria( false )
,	_screenBasedCriteriaCoefficient( 1.f )
,	_materialAlphaCorrectionCoefficient( 1.f / 512.f )
{
}
...
bool ProxyGeometry::initialize()
{
	...
	const QString shaderRepository = dataRepository + QDir::separator() + QString( "Shaders" ) + QDir::separator() + QString( "GvProxyGeometryManager" );
 ...
 ******************************************************************************/
bool ProxyGeometry::getScreenBasedCriteria() const
{
 ...
 ******************************************************************************/
void ProxyGeometry::setScreenBasedCriteria( bool pFlag )
{
 ...
 ******************************************************************************/
float ProxyGeometry::getScreenBasedCriteriaCoefficient() const
{
	return _screenBasedCriteriaCoefficient;
}
 ...
 ******************************************************************************/
void ProxyGeometry::setScreenBasedCriteriaCoefficient( float pValue )
{
	_screenBasedCriteriaCoefficient = pValue;
}
 ...
 ******************************************************************************/
float ProxyGeometry::getMaterialAlphaCorrectionCoefficient() const
{
	return _materialAlphaCorrectionCoefficient;
}
 ...
 ******************************************************************************/
void ProxyGeometry::setMaterialAlphaCorrectionCoefficient( float pValue )
{
	_materialAlphaCorrectionCoefficient = pValue;
}
