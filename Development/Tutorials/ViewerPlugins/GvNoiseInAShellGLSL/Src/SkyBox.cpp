...
bool SkyBox::initialize()
{
	...
	dataRepository += QDir::separator();
	dataRepository += QString( "GvNoiseInAShellGLSL" );
	dataRepository += QDir::separator();
	...
	//filename = dataRepository + QString( "posx.jpg" );
	//faceFilenames[ ePositiveX ] = filename.toStdString();
	//filename = dataRepository + QString( "negx.jpg" );
	//faceFilenames[ eNegativeX ] = filename.toStdString();
	//filename = dataRepository + QString( "posy.jpg" );
	//faceFilenames[ ePositiveY ] = filename.toStdString();
	//filename = dataRepository + QString( "negy.jpg" );
	//faceFilenames[ eNegativeY ] = filename.toStdString();
	//filename = dataRepository + QString( "posz.jpg" );
	//faceFilenames[ ePositiveZ ] = filename.toStdString();
	//filename = dataRepository + QString( "negz.jpg" );
