...
void SampleCore::init()
{
	...
	setMaxNbLoops( 200 );
	// - Noise producer
	//setNoiseFirstFrequency( 2.5f );
	//setNoiseStrength( 5.3f );
	setNoiseFirstFrequency( 0.8f );
	setNoiseStrength( 11.f );
...
void SampleCore::resize( int pWidth, int pHeight )
{
	...
	// Update proxy geometry graphics resources
	//RendererType* renderer = dynamic_cast< RendererType* >( _pipeline->editRenderer() );
	/*_pipeline->editRenderer()*/_renderer->_proxyGeometry->setBufferSize( mWidth, mHeight );
}
...
{
	RendererType* renderer = dynamic_cast< RendererType* >( _pipeline->editRenderer() );
	return renderer->getShaderProgram()->reloadShader( static_cast< GsGraphics::GsShaderProgram::ShaderType >( pShaderType ) );
}
 ...
 ******************************************************************************/
bool SampleCore::hasProxyGeometry() const
{
	RendererType* renderer = dynamic_cast< RendererType* >( _pipeline->editRenderer() );
	return renderer->hasProxyGeometry();
}
 ...
 ******************************************************************************/
void SampleCore::setProxyGeometry( bool pFlag )
{
	RendererType* renderer = dynamic_cast< RendererType* >( _pipeline->editRenderer() );
	return renderer->setProxyGeometry( pFlag );
}
 ...
 ******************************************************************************/
bool SampleCore::isProxyGeometryVisible() const
{
	RendererType* renderer = dynamic_cast< RendererType* >( _pipeline->editRenderer() );
	return renderer->isProxyGeometryVisible();
}
 ...
 ******************************************************************************/
void SampleCore::setProxyGeometryVisible( bool pFlag )
{
	RendererType* renderer = dynamic_cast< RendererType* >( _pipeline->editRenderer() );
	return renderer->setProxyGeometryVisible( pFlag );
}
...
{
	RendererType* renderer = dynamic_cast< RendererType* >( _pipeline->editRenderer() );
	return renderer->_proxyGeometry->get3DModelFilename();
}
...
void SampleCore::set3DModelFilename( const string& pFilename )
{
	...
	if ( renderer->_proxyGeometry != NULL )
	{
		delete renderer->_proxyGeometry;
		renderer->_proxyGeometry = NULL;
	...
	renderer->_proxyGeometry = new ProxyGeometry();
	...
	renderer->_proxyGeometry->set3DModelFilename( pFilename );
	bool statusOK = renderer->_proxyGeometry->initialize();
	assert( statusOK );
	...
	renderer->_proxyGeometry->setBufferSize( /*pWidth*/mWidth, /*pHeight*/mHeight );
