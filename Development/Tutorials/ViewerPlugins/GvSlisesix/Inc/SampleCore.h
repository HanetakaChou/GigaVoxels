...
public:
	 ...
	 */
	void setCeilingState( bool pFlag );
	 ...
	 */
	void setColumnsState( bool pFlag );

	/**
	 * Get the monster distance field state
	 *
	 * @return the monster distance field state
	 */
	bool getMonsterState() const;

	/**
	 * Set the monster distance field state
	 *
	 * @param pFlag the monster distance field state
	 */
	void setMonsterState( bool pFlag );
	 ...
	 */
	void getEyePosition( float& pX, float& pY, float& pZ ) const;
	 ...
	 * @param pZ the z eye position
	 */
	void setEyePosition( float pX, float pY, float pZ );
	 ...
	 * Set the map scale
	 *
	 * @param pValue the map scale
	 */
	void setMapScale( float pValue );
	 ...
	 *
	 * @param pFlag the flag telling wheter or not bump mapping is activated
	 */
	void setBumpMapping( bool pFlag );

	/**
	 * Get the flag telling wheter or not ambient occlusion mapping is activated
	 *
	 ...
	 *
	 * @param pFlag the flag telling wheter or not ambient occlusion is activated
	 */
	void setAmbientOcclusion( bool pFlag );
	 ...
	 */
	bool useSoftShadows() const;

	/**
	 * Set the flag telling wheter or not soft shadows is activated
	 *
	 * @param pFlag the flag telling wheter or not soft shadows is activated
	 */
	void setSoftShadows( bool pFlag );
...
protected:
	...
	float3 _eyePosition;
	float _mapScale;
	bool _useBumpMapping;
	bool _useAmbientOcclusion;
	bool _useSoftShadows;
