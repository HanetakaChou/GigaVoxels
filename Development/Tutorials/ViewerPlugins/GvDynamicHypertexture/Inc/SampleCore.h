...
public:
	 ...
	 */
	float getNoiseShellWidth() const;

	/**
	 * Set the noise shell width
	 *
	 * @param pValue the noise new shell width
	 */
	void setNoiseShellWidth( float pValue );
	 ...
	 */
	void setNoiseShellWidthUpperBound( float pValue );

	/**
	 * Get the noise shell width upper bound
	 */
	float getNoiseShellWidthUpperBound();

	/**
	 * Set the noise function modifier
	 *
	 * @param pValue the id of the modifier function
	 */
	void setNoiseFunctionModifier( int pValue );

	/**
	 * Get the noise function modifier
	 */
	int getNoiseFunctionModifier();

	/**
	 * Set the displacement type
	 *
	 * @param value the displacement type
	 */
	 ...
	 *
	 * @param checked the fill the shape
	 */
	void setFillTheShape( int value );
...
protected:
	 ...
	 * Noise shell width
	 */
	float _noiseShellWidth;

	/**
	 * Noise shell width upper bound
	 */
	float _noiseShellWidthUpperBound;

	/**
	 * Noise function modifier (abs, 1-abs,etc)
	 */
	int _noiseFunctionModifier;

	/**
	 * Noise displacement type
	 * 0 -> color
	 * 1 -> normal
	 */
	int _noiseDisplacement;

	/**
	 * Noise fill the shape value
	 * 0 -> fill it from upper bound
	 * 1 -> fill it from 0
	 * 2 -> don't fill it
	 */
	int _noiseFillTheShape;
