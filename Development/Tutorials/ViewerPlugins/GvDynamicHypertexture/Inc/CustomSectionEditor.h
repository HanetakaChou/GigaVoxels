...
private slots:
	...
	/**
	 * Slot called when noise ShellWidth value has changed
	 */
	void on__noiseShellWidthSpinBox_valueChanged( double value );
	
	/**
	 * Slot called when noise ShellWidthUpperBound value has changed
	 */
	void on__noiseShellWidthUpperBoundSpinBox_valueChanged( double value );

	/**
	 * Slot called when noise noise action displacement value has changed
	 */
	void on__noiseActionDisplacement_currentIndexChanged ( int value );

	/**
	 * Slot called when FillTheShape value has changed
	 */
	void on__noiseFillTheShapeCheckBox_clicked (bool checked );
	...
	/**
	 * Slot called when the noise modifier function is changed
	 */
	void on__noiseComboBox_currentIndexChanged( int value );

	/**
	 * Slot called when the animate check box value is changed
	 */
	void on__animateCheckBox_clicked (bool checked );
