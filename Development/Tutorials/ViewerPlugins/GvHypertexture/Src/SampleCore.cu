 ...
 ******************************************************************************/
float SampleCore::getThickness() const
{
	return _thickness;
}
 ...
 ******************************************************************************/
void SampleCore::setThickness( float pValue )
{
	_thickness = pValue;
	
	// Update device memory
	GS_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cThickness, &_thickness, sizeof( _thickness ), 0, cudaMemcpyHostToDevice ) );
 ...
 ******************************************************************************/
void SampleCore::setA( float pValue )
{
	_a = pValue;
	
	// Update device memory
	GS_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cA, &_a, sizeof( _a ), 0, cudaMemcpyHostToDevice ) );
 ...
 ******************************************************************************/
void SampleCore::setB( float pValue )
{
	_b = pValue;
	
	// Update device memory
	GS_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cB, &_b, sizeof( _b ), 0, cudaMemcpyHostToDevice ) );
 ...
 ******************************************************************************/
float SampleCore::getEpsillon() const
{
	return _epsillon;
}
 ...
 ******************************************************************************/
void SampleCore::setEpsillon( float pValue )
{
	_epsillon = pValue;
	
	// Update device memory
	GS_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cEpsillon, &_epsillon, sizeof( _epsillon ), 0, cudaMemcpyHostToDevice ) );
