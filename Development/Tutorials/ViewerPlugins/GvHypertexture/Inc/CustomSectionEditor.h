...
private slots:
	 ...
	 */
	void on__thicknessSpinBox_valueChanged( double value );

	/**
	 * Slot called when light position Y value has changed
	 */
	void on__aSpinBox_valueChanged( double value );

	/**
	 * Slot called when light position Z value has changed
	 */
	void on__bSpinBox_valueChanged( double value );

	/**
	 * Slot called when shader opacity threshold value has changed
	 */
	void on__epsillonSpinBox_valueChanged( double value );
