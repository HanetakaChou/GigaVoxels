...
{
	// Init Glsl program 
	//GLuint prog = GvUtils::GsShaderManager::createShaderProgram( "Data/Shaders/Voxelization/organizeTriangle_VS.glsl", "Data/Shaders/Voxelization/organizeTriangle_GS.glsl", "Data/Shaders/Voxelization/organizeTriangle_FS.glsl" );
	...
	vertexShaderFilename += QString( "organizeTriangle_VS.glsl" );
	QString geometryShaderFilename = shaderRepository;
	geometryShaderFilename += QDir::separator();
	geometryShaderFilename += QString( "organizeTriangle_GS.glsl" );
	QString fragmentShaderFilename = shaderRepository;
	fragmentShaderFilename += QDir::separator();
	fragmentShaderFilename += QString( "organizeTriangle_FS.glsl" );
	GLuint prog = GvUtils::GsShaderManager::createShaderProgram( vertexShaderFilename.toLatin1().constData(), geometryShaderFilename.toLatin1().constData(), fragmentShaderFilename.toLatin1().constData() );
	GvUtils::GsShaderManager::linkShaderProgram( prog );
