...
:	GvRendering::GvRenderer< TVolumeTreeType, TVolumeTreeCacheType >( pVolumeTree, pVolumeTreeCache )
{
	...
	QString vertexShaderFilename = dataRepository + QDir::separator() + QString( "Shaders" ) + QDir::separator() + QString( "CastShadows" ) + QDir::separator() + QString( "gvCastingShadowVert.glsl" );
	//QString vertexShaderFilename = QString("/home/maverick/bellouki/Gigavoxels/Development/Tutorials/Demos/GraphicsInteroperability/CastShadows/Res/gvCastingShadowVert.glsl");
	...
	//}
	QString fragmentShaderFilename = dataRepository + QDir::separator() + QString( "Shaders" ) + QDir::separator() + QString( "CastShadows" ) + QDir::separator() + QString( "gvCastingShadowFrag.glsl" );
	//QString fragmentShaderFilename = QString("/home/maverick/bellouki/Gigavoxels/Development/Tutorials/Demos/GraphicsInteroperability/CastShadows/Res/gvCastingShadowFrag.glsl");
