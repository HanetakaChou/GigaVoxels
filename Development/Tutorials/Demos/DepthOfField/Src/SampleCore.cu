...
void SampleCore::init()
{
	...
	size_t nodePoolNumElems = NODEPOOL_MEMSIZE / sizeof(GvStructure::GsNode);
...
void SampleCore::setAperture( float pValue )
{
	...
	GS_CUDA_SAFE_CALL( cudaMemcpyToSymbol( cDofParameters, (&_dofParameters), sizeof( _dofParameters ), 0, cudaMemcpyHostToDevice ) );
